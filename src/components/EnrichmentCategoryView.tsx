      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        ...
        <div className="space-y-4">
          {filteredEnrichments.length === 0 ? (
            ...
            } else if (enrichment.id === 'datasf_street_sidewalk_cleaning' || enrichment.id === 'datasf_dbi_notices_of_violation') {
              radiusOptions = [0.5, 1.0, 2.5, 5.0];
            } else if (enrichment.id === 'datasf_sf_311_cases') {
              radiusOptions = [0.25];
            ...
            const getRadiusUnit = () => {
              ...
              return currentRadius === 1 ? 'mile' : 'miles';
            };
