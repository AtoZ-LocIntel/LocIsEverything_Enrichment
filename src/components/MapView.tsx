...
if (bounds.isValid() && results.length > 1) {
  ...
  return (
    <div className="h-full flex flex-col bg-white" style={{ height: '100vh', paddingTop: isMobile ? '0' : '7rem' }}>
      ...
      {/* Map Container */}
      <div className="flex-1 relative map-view-container" style={{ height: isMobile ? 'calc(100dvh - 6rem)' : 'calc(100vh - 14rem)' }}>
        <div ref={mapRef} className="w-full h-full map-container" style={{ height: isMobile ? 'calc(100dvh - 6rem)' : 'calc(100vh - 14rem)' }} />
