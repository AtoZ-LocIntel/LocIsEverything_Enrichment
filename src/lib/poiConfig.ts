...
export const DEFAULT_POI_TYPES: POIConfig[] = [
  ...
  // Health
  { id: 'poi_osm_health_medical_care', label: 'OSM Medical Care', description: 'OpenStreetMap - Hospitals, clinics, doctors, specialists (proximity queries up to 25 miles)', isPOI: true, defaultRadius: 5, maxRadius: 25, category: 'health', section: 'health' },
  { id: 'poi_osm_health_mental_behavioral', label: 'OSM Mental & Behavioral Health', description: 'OpenStreetMap - Psychotherapists, psychologists, psychiatrists, mental health clinics (proximity queries up to 25 miles)', isPOI: true, defaultRadius: 5, maxRadius: 25, category: 'health', section: 'health' },
  { id: 'poi_osm_health_pharmacy_diagnostics', label: 'OSM Pharmacy & Diagnostics', description: 'OpenStreetMap - Pharmacies, laboratories, diagnostic centers (proximity queries up to 25 miles)', isPOI: true, defaultRadius: 5, maxRadius: 25, category: 'health', section: 'health' },
  { id: 'poi_osm_health_fitness_movement', label: 'OSM Fitness & Movement', description: 'OpenStreetMap - Fitness centers, gyms, sports centers, physiotherapists (proximity queries up to 25 miles)', isPOI: true, defaultRadius: 5, maxRadius: 25, category: 'health', section: 'health' },
  { id: 'poi_osm_health_wellness_alternative', label: 'OSM Wellness & Alternative Care', description: 'OpenStreetMap - Chiropractors, acupuncturists, massage, naturopaths, osteopaths (proximity queries up to 25 miles)', isPOI: true, defaultRadius: 5, maxRadius: 25, category: 'health', section: 'health' },
  { id: 'poi_osm_health_dental_vision', label: 'OSM Dental & Vision', description: 'OpenStreetMap - Dentists, orthodontists, oral surgeons, optometrists, ophthalmologists (proximity queries up to 25 miles)', isPOI: true, defaultRadius: 5, maxRadius: 25, category: 'health', section: 'health' },
  { id: 'poi_osm_health_public_community', label: 'OSM Public & Community Health', description: 'OpenStreetMap - Public health facilities, community health centers (proximity queries up to 25 miles)', isPOI: true, defaultRadius: 5, maxRadius: 25, category: 'health', section: 'health' },
  { id: 'poi_osm_health_senior_assisted', label: 'OSM Senior & Assisted Care', description: 'OpenStreetMap - Nursing homes, assisted living, rehabilitation, hospices (proximity queries up to 25 miles)', isPOI: true, defaultRadius: 5, maxRadius: 25, category: 'health', section: 'health' },
  ...
  { id: 'poi_aurora_viewing_sites', label: 'Aurora Viewing Sites', description: 'Auroras.live curated northern/southern lights viewing locations', isPOI: true, defaultRadius: 100, maxRadius: 100, category: 'quirky', section: 'quirky' },
  ...
  { id: 'median_sea_ice_extent_antarctic', label: 'Median Sea Ice Extent - Antarctic', description: 'Median sea ice extent for the Antarctic (point-in-polygon and proximity up to 100 miles)', isPOI: true, defaultRadius: 50, maxRadius: 100, category: 'quirky', section: 'quirky', subCategory: '' },
  { id: 'median_sea_ice_extent_arctic', label: 'Median Sea Ice Extent - Arctic', description: 'Median sea ice extent for the Arctic (point-in-polygon and proximity up to 100 miles)', isPOI: true, defaultRadius: 50, maxRadius: 100, category: 'quirky', section: 'quirky', subCategory: '' },
  ...
  { id: 'nri_hurricane_annualized_frequency_county', label: 'NRI Hurricane Annualized Frequency (County)', description: 'FEMA National Risk Index - Annualized frequency of hurricane events (County). Point-in-polygon + proximity up to 25 miles.', isPOI: true, defaultRadius: 25, maxRadius: 25, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_hurricane_annualized_frequency_census_tract', label: 'NRI Hurricane Annualized Frequency (Census Tract)', description: 'FEMA National Risk Index - Annualized frequency of hurricane events (Census Tract). Point-in-polygon + proximity up to 10 miles.', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_hail_annualized_frequency_county', label: 'NRI Hail Annualized Frequency (County)', description: 'FEMA National Risk Index - Annualized frequency of hail events (County). Point-in-polygon + proximity up to 25 miles.', isPOI: true, defaultRadius: 25, maxRadius: 25, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_hail_annualized_frequency_census_tract', label: 'NRI Hail Annualized Frequency (Census Tract)', description: 'FEMA National Risk Index - Annualized frequency of hail events (Census Tract). Point-in-polygon + proximity up to 10 miles.', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_tornado_annualized_frequency_county', label: 'NRI Tornado Annualized Frequency (County)', description: 'FEMA National Risk Index - Annualized frequency of tornado events (County). Point-in-polygon + proximity up to 25 miles.', isPOI: true, defaultRadius: 25, maxRadius: 25, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_tornado_annualized_frequency_census_tract', label: 'NRI Tornado Annualized Frequency (Census Tract)', description: 'FEMA National Risk Index - Annualized frequency of tornado events (Census Tract). Point-in-polygon + proximity up to 10 miles.', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_earthquake_annualized_frequency_county', label: 'NRI Earthquake Annualized Frequency (County)', description: 'FEMA National Risk Index - Annualized frequency of earthquake events (County). Point-in-polygon + proximity up to 25 miles.', isPOI: true, defaultRadius: 25, maxRadius: 25, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_earthquake_annualized_frequency_census_tract', label: 'NRI Earthquake Annualized Frequency (Census Tract)', description: 'FEMA National Risk Index - Annualized frequency of earthquake events (Census Tract). Point-in-polygon + proximity up to 10 miles.', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_drought_annualized_frequency_county', label: 'NRI Drought Annualized Frequency (County)', description: 'FEMA National Risk Index - Annualized frequency of drought events (County). Point-in-polygon + proximity up to 25 miles.', isPOI: true, defaultRadius: 25, maxRadius: 25, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_drought_annualized_frequency_census_tract', label: 'NRI Drought Annualized Frequency (Census Tract)', description: 'FEMA National Risk Index - Annualized frequency of drought events (Census Tract). Point-in-polygon + proximity up to 10 miles.', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_wildfire_annualized_frequency_county', label: 'NRI Wildfire Annualized Frequency (County)', description: 'FEMA National Risk Index - Annualized frequency of wildfire events (County). Point-in-polygon + proximity up to 25 miles.', isPOI: true, defaultRadius: 25, maxRadius: 25, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_wildfire_annualized_frequency_census_tract', label: 'NRI Wildfire Annualized Frequency (Census Tract)', description: 'FEMA National Risk Index - Annualized frequency of wildfire events (Census Tract). Point-in-polygon + proximity up to 10 miles.', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_lightning_annualized_frequency_county', label: 'NRI Lightning Annualized Frequency (County)', description: 'FEMA National Risk Index - Annualized frequency of lightning events (County). Point-in-polygon + proximity up to 25 miles.', isPOI: true, defaultRadius: 25, maxRadius: 25, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_lightning_annualized_frequency_census_tract', label: 'NRI Lightning Annualized Frequency (Census Tract)', description: 'FEMA National Risk Index - Annualized frequency of lightning events (Census Tract). Point-in-polygon + proximity up to 10 miles.', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_ice_storm_annualized_frequency_county', label: 'NRI Ice Storm Annualized Frequency (County)', description: 'FEMA National Risk Index - Annualized frequency of ice storm events (County). Point-in-polygon + proximity up to 25 miles.', isPOI: true, defaultRadius: 25, maxRadius: 25, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_ice_storm_annualized_frequency_census_tract', label: 'NRI Ice Storm Annualized Frequency (Census Tract)', description: 'FEMA National Risk Index - Annualized frequency of ice storm events (Census Tract). Point-in-polygon + proximity up to 10 miles.', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_coastal_flooding_annualized_frequency_county', label: 'NRI Coastal Flooding Annualized Frequency (County)', description: 'FEMA National Risk Index - Annualized frequency of coastal flooding events (County). Point-in-polygon + proximity up to 25 miles.', isPOI: true, defaultRadius: 25, maxRadius: 25, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_coastal_flooding_annualized_frequency_census_tract', label: 'NRI Coastal Flooding Annualized Frequency (Census Tract)', description: 'FEMA National Risk Index - Annualized frequency of coastal flooding events (Census Tract). Point-in-polygon + proximity up to 10 miles.', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_riverine_flooding_annualized_frequency_county', label: 'NRI Riverine Flooding Annualized Frequency (County)', description: 'FEMA National Risk Index - Annualized frequency of riverine flooding events (County). Point-in-polygon + proximity up to 25 miles.', isPOI: true, defaultRadius: 25, maxRadius: 25, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_riverine_flooding_annualized_frequency_census_tract', label: 'NRI Riverine Flooding Annualized Frequency (Census Tract)', description: 'FEMA National Risk Index - Annualized frequency of riverine flooding events (Census Tract). Point-in-polygon + proximity up to 10 miles.', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_landslide_annualized_frequency_county', label: 'NRI Landslide Annualized Frequency (County)', description: 'FEMA National Risk Index - Annualized frequency of landslide events (County). Point-in-polygon + proximity up to 25 miles.', isPOI: true, defaultRadius: 25, maxRadius: 25, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_landslide_annualized_frequency_census_tract', label: 'NRI Landslide Annualized Frequency (Census Tract)', description: 'FEMA National Risk Index - Annualized frequency of landslide events (Census Tract). Point-in-polygon + proximity up to 10 miles.', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_strong_wind_annualized_frequency_county', label: 'NRI Strong Wind Annualized Frequency (County)', description: 'FEMA National Risk Index - Annualized frequency of strong wind events (County). Point-in-polygon + proximity up to 25 miles.', isPOI: true, defaultRadius: 25, maxRadius: 25, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_strong_wind_annualized_frequency_census_tract', label: 'NRI Strong Wind Annualized Frequency (Census Tract)', description: 'FEMA National Risk Index - Annualized frequency of strong wind events (Census Tract). Point-in-polygon + proximity up to 10 miles.', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_winter_weather_annualized_frequency_county', label: 'NRI Winter Weather Annualized Frequency (County)', description: 'FEMA National Risk Index - Annualized frequency of winter weather events (County). Point-in-polygon + proximity up to 25 miles.', isPOI: true, defaultRadius: 25, maxRadius: 25, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_winter_weather_annualized_frequency_census_tract', label: 'NRI Winter Weather Annualized Frequency (Census Tract)', description: 'FEMA National Risk Index - Annualized frequency of winter weather events (Census Tract). Point-in-polygon + proximity up to 10 miles.', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_cold_wave_annualized_frequency_county', label: 'NRI Cold Wave Annualized Frequency (County)', description: 'FEMA National Risk Index - Annualized frequency of cold wave events (County). Point-in-polygon + proximity up to 25 miles.', isPOI: true, defaultRadius: 25, maxRadius: 25, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_cold_wave_annualized_frequency_census_tract', label: 'NRI Cold Wave Annualized Frequency (Census Tract)', description: 'FEMA National Risk Index - Annualized frequency of cold wave events (Census Tract). Point-in-polygon + proximity up to 10 miles.', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_heat_wave_annualized_frequency_county', label: 'NRI Heat Wave Annualized Frequency (County)', description: 'FEMA National Risk Index - Annualized frequency of heat wave events (County). Point-in-polygon + proximity up to 25 miles.', isPOI: true, defaultRadius: 25, maxRadius: 25, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_heat_wave_annualized_frequency_census_tract', label: 'NRI Heat Wave Annualized Frequency (Census Tract)', description: 'FEMA National Risk Index - Annualized frequency of heat wave events (Census Tract). Point-in-polygon + proximity up to 10 miles.', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_avalanche_annualized_frequency_county', label: 'NRI Avalanche Annualized Frequency (County)', description: 'FEMA National Risk Index - Annualized frequency of avalanche events (County). Point-in-polygon + proximity up to 25 miles.', isPOI: true, defaultRadius: 25, maxRadius: 25, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_avalanche_annualized_frequency_census_tract', label: 'NRI Avalanche Annualized Frequency (Census Tract)', description: 'FEMA National Risk Index - Annualized frequency of avalanche events (Census Tract). Point-in-polygon + proximity up to 10 miles.', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_tsunami_annualized_frequency_county', label: 'NRI Tsunami Annualized Frequency (County)', description: 'FEMA National Risk Index - Annualized frequency of tsunami events (County). Point-in-polygon + proximity up to 25 miles.', isPOI: true, defaultRadius: 25, maxRadius: 25, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_tsunami_annualized_frequency_census_tract', label: 'NRI Tsunami Annualized Frequency (Census Tract)', description: 'FEMA National Risk Index - Annualized frequency of tsunami events (Census Tract). Point-in-polygon + proximity up to 10 miles.', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_volcanic_activity_annualized_frequency_county', label: 'NRI Volcanic Activity Annualized Frequency (County)', description: 'FEMA National Risk Index - Annualized frequency of volcanic activity events (County). Point-in-polygon + proximity up to 25 miles.', isPOI: true, defaultRadius: 25, maxRadius: 25, category: 'wildfire', section: 'wildfire' },
  { id: 'nri_volcanic_activity_annualized_frequency_census_tract', label: 'NRI Volcanic Activity Annualized Frequency (Census Tract)', description: 'FEMA National Risk Index - Annualized frequency of volcanic activity events (Census Tract). Point-in-polygon + proximity up to 10 miles.', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire' },
  { id: 'satellite_viirs_fire_activity', label: 'Satellite VIIRS Fire Activity', description: 'Satellite VIIRS Thermal Hotspots and Fire Activity - thermal hotspots and active fire detections from satellite imagery', isPOI: true, defaultRadius: 5, maxRadius: 25, category: 'wildfire', section: 'wildfire' },
  ...
  { id: 'nws_hurricane_forecast_position', label: 'NWS Hurricane Forecast Position', description: 'National Weather Service - Hurricane forecast positions for point-in-polygon and proximity queries (up to 100 miles)', isPOI: true, defaultRadius: 25, maxRadius: 100, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_hurricane_observed_position', label: 'NWS Hurricane Observed Position', description: 'National Weather Service - Hurricane observed positions for point-in-polygon and proximity queries (up to 100 miles)', isPOI: true, defaultRadius: 25, maxRadius: 100, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_hurricane_forecast_track', label: 'NWS Hurricane Forecast Track', description: 'National Weather Service - Hurricane forecast tracks for point-in-polygon and proximity queries (up to 100 miles)', isPOI: true, defaultRadius: 25, maxRadius: 100, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_hurricane_observed_track', label: 'NWS Hurricane Observed Track', description: 'National Weather Service - Hurricane observed tracks for point-in-polygon and proximity queries (up to 100 miles)', isPOI: true, defaultRadius: 25, maxRadius: 100, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_hurricane_forecast_error_cone', label: 'NWS Hurricane Forecast Error Cone', description: 'National Weather Service - Hurricane forecast error cone and danger area for point-in-polygon and proximity queries (up to 100 miles)', isPOI: true, defaultRadius: 25, maxRadius: 100, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_hurricane_watches_warnings', label: 'NWS Hurricane Watches and Warnings', description: 'National Weather Service - Hurricane watches and warnings for point-in-polygon and proximity queries (up to 100 miles)', isPOI: true, defaultRadius: 25, maxRadius: 100, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_hurricane_tropical_storm_force', label: 'NWS Tropical Storm Force (34kts)', description: 'National Weather Service - Tropical storm force wind areas (34kts) for point-in-polygon and proximity queries (up to 100 miles)', isPOI: true, defaultRadius: 25, maxRadius: 100, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_hurricane_strong_tropical_storm', label: 'NWS Strong Tropical Storm (50kts)', description: 'National Weather Service - Strong tropical storm wind areas (50kts) for point-in-polygon and proximity queries (up to 100 miles)', isPOI: true, defaultRadius: 25, maxRadius: 100, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_hurricane_force', label: 'NWS Hurricane Force (64kts+)', description: 'National Weather Service - Hurricane force wind areas (64kts+) for point-in-polygon and proximity queries (up to 100 miles)', isPOI: true, defaultRadius: 25, maxRadius: 100, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_hurricane_raw_data', label: 'NWS Hurricane Raw Data', description: 'National Weather Service - Raw 1/10th degree hurricane data for point-in-polygon and proximity queries (up to 100 miles)', isPOI: true, defaultRadius: 25, maxRadius: 100, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_hurricane_observed_wind_swath', label: 'NWS Hurricane Observed Wind Swath', description: 'National Weather Service - Hurricane observed wind swath for point-in-polygon and proximity queries (up to 100 miles)', isPOI: true, defaultRadius: 25, maxRadius: 100, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_ndfd_wind_national', label: 'NDFD Wind Forecast - National', description: 'National Weather Service - NDFD Wind Forecast at National Level for proximity queries (up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_ndfd_wind_regional', label: 'NDFD Wind Forecast - Regional', description: 'National Weather Service - NDFD Wind Forecast at Regional Level for proximity queries (up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_ndfd_wind_state', label: 'NDFD Wind Forecast - State', description: 'National Weather Service - NDFD Wind Forecast at State Level for proximity queries (up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_ndfd_wind_county', label: 'NDFD Wind Forecast - County', description: 'National Weather Service - NDFD Wind Forecast at County Level for proximity queries (up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_ndfd_wind_district', label: 'NDFD Wind Forecast - District', description: 'National Weather Service - NDFD Wind Forecast at District Level for proximity queries (up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_ndfd_wind_block_group', label: 'NDFD Wind Forecast - Block Group', description: 'National Weather Service - NDFD Wind Forecast at Block Group Level for proximity queries (up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_ndfd_wind_city', label: 'NDFD Wind Forecast - City', description: 'National Weather Service - NDFD Wind Forecast at City Level for proximity queries (up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_forecasted_snowfall', label: 'NDFD Forecasted Snowfall', description: 'Forecasted snowfall (point-in-polygon and proximity up to 100 miles)', isPOI: true, defaultRadius: 25, maxRadius: 100, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_forecasted_precipitation', label: 'NDFD Forecasted Precipitation', description: 'Forecasted precipitation (point-in-polygon and proximity up to 100 miles)', isPOI: true, defaultRadius: 25, maxRadius: 100, category: 'nws', section: 'nws', subCategory: '' },
  ...
  { id: 'nws_stream_gauges_live', label: 'USGS Stream Gauges (Live)', description: 'Live stream gauges with status; proximity up to 25 miles', isPOI: true, defaultRadius: 10, maxRadius: 25, category: 'nws', section: 'nws', subCategory: '' },
  ...
  { id: 'fema_nfhl_profile_baselines', label: 'FEMA Profile Baselines', description: 'FEMA Profile Baselines (proximity up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire', subCategory: '' },
  { id: 'fema_nfhl_water_lines', label: 'FEMA Water Lines', description: 'FEMA Water Lines (proximity up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire', subCategory: '' },
  ...
  { id: 'fema_nfhl_levees', label: 'FEMA Levees', description: 'FEMA Levees (proximity up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire', subCategory: '' },
  ...
  { id: 'fema_nfhl_transect_baselines', label: 'FEMA Transect Baselines', description: 'FEMA Transect Baselines (proximity up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire', subCategory: '' },
  { id: 'fema_nfhl_general_structures', label: 'FEMA General Structures', description: 'FEMA General Structures (proximity up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire', subCategory: '' },
  { id: 'fema_nfhl_river_mile_markers', label: 'FEMA River Mile Markers', description: 'FEMA River Mile Markers (proximity up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire', subCategory: '' },
  ...
  { id: 'fema_nfhl_datum_conversion_points', label: 'FEMA Datum Conversion Points', description: 'FEMA Datum Conversion Points (proximity up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire', subCategory: '' },
  { id: 'fema_nfhl_coastal_gages', label: 'FEMA Coastal Gages', description: 'FEMA Coastal Gages (proximity up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire', subCategory: '' },
  { id: 'fema_nfhl_gages', label: 'FEMA Gages', description: 'FEMA Gages (proximity up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire', subCategory: '' },
  { id: 'fema_nfhl_nodes', label: 'FEMA Nodes', description: 'FEMA Nodes (proximity up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire', subCategory: '' },
  { id: 'fema_nfhl_high_water_marks', label: 'FEMA High Water Marks', description: 'FEMA High Water Marks (proximity up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire', subCategory: '' },
  { id: 'fema_nfhl_station_start_points', label: 'FEMA Station Start Points', description: 'FEMA Station Start Points (proximity up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire', subCategory: '' },
  { id: 'fema_nfhl_hydrologic_reaches', label: 'FEMA Hydrologic Reaches', description: 'FEMA Hydrologic Reaches (proximity up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'wildfire', section: 'wildfire', subCategory: '' },
  ...
  { id: 'uk_built_up_areas_2024', label: 'UK Built-Up Areas (Dec 2024)', description: 'UK Office for National Statistics - Built-Up Areas 2024 (point-in-polygon and proximity queries up to 25 miles)', isPOI: true, defaultRadius: 5, maxRadius: 25, category: 'ukstats', section: 'uk' },
  { id: 'uk_wales_local_health_boards', label: 'Wales Local Health Boards', description: 'UK Office for National Statistics - Wales Local Health Boards December 2023 (point-in-polygon and proximity queries up to 25 miles)', isPOI: true, defaultRadius: 5, maxRadius: 25, category: 'ukstats', section: 'uk' },
  ...
  { id: 'uk_european_electoral_regions', label: 'European Electoral Regions (Dec 2018)', description: 'European Electoral Regions Dec 2018 Boundaries (United Kingdom) - point-in-polygon and proximity queries up to 25 miles', isPOI: true, defaultRadius: 5, maxRadius: 25, category: 'ukstats', section: 'uk' }
];
