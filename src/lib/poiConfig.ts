...
export const DEFAULT_POI_TYPES: POIConfig[] = [
  ...
  { id: 'la_county_metro_lines', label: 'LA County MTA Metro Lines', description: 'LA County - MTA Metro Lines (rail and bus) for proximity queries (up to 25 miles)', isPOI: true, defaultRadius: 5, maxRadius: 25, category: 'ca', section: 'ca', subCategory: 'Transportation' },
