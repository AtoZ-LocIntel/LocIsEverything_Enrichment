...
export const DEFAULT_POI_TYPES: POIConfig[] = [
  ...
  { id: 'ca_frap_facilities', label: 'CA FRAP Facilities', description: 'CAL FIRE - State and Local Facilities for Wildland Fire Protection. Fire stations, command centers, and fire protection facilities. Proximity queries up to 50 miles.', isPOI: true, defaultRadius: 5, maxRadius: 50, category: 'ca', section: 'ca' },
