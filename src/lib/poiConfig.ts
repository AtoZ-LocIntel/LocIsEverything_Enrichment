...
export const DEFAULT_POI_TYPES: POIConfig[] = [
  ...
  { id: 'nws_ndfd_wind_national', label: 'NWS NDFD Wind Forecast - National', description: 'National Weather Service - NDFD Wind Forecast at National Level for proximity queries (up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_ndfd_wind_regional', label: 'NWS NDFD Wind Forecast - Regional', description: 'National Weather Service - NDFD Wind Forecast at Regional Level for proximity queries (up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_ndfd_wind_state', label: 'NWS NDFD Wind Forecast - State', description: 'National Weather Service - NDFD Wind Forecast at State Level for proximity queries (up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_ndfd_wind_county', label: 'NWS NDFD Wind Forecast - County', description: 'National Weather Service - NDFD Wind Forecast at County Level for proximity queries (up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_ndfd_wind_district', label: 'NWS NDFD Wind Forecast - District', description: 'National Weather Service - NDFD Wind Forecast at District Level for proximity queries (up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_ndfd_wind_block_group', label: 'NWS NDFD Wind Forecast - Block Group', description: 'National Weather Service - NDFD Wind Forecast at Block Group Level for proximity queries (up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_ndfd_wind_city', label: 'NWS NDFD Wind Forecast - City', description: 'National Weather Service - NDFD Wind Forecast at City Level for proximity queries (up to 10 miles)', isPOI: true, defaultRadius: 5, maxRadius: 10, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_forecasted_snowfall', label: 'NWS Forecasted Snowfall', description: 'National Weather Service - Forecasted snowfall (point-in-polygon and proximity up to 100 miles)', isPOI: true, defaultRadius: 25, maxRadius: 100, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_forecasted_precipitation', label: 'NWS Forecasted Precipitation', description: 'National Weather Service - Forecasted precipitation (point-in-polygon and proximity up to 100 miles)', isPOI: true, defaultRadius: 25, maxRadius: 100, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_ndfd_ice_amount_by_time', label: 'NWS NDFD Ice - Amount by Time', description: 'National Weather Service - Forecasted ice amount by time (point-in-polygon and proximity up to 50 miles)', isPOI: true, defaultRadius: 25, maxRadius: 50, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_ndfd_ice_accumulation_by_time', label: 'NWS NDFD Ice - Accumulation by Time', description: 'National Weather Service - Forecasted ice accumulation by time (point-in-polygon and proximity up to 50 miles)', isPOI: true, defaultRadius: 25, maxRadius: 50, category: 'nws', section: 'nws', subCategory: '' },
  { id: 'nws_ndfd_ice_cumulative_total', label: 'NWS NDFD Ice - Cumulative Total', description: 'National Weather Service - Forecasted ice cumulative total (point-in-polygon and proximity up to 50 miles)', isPOI: true, defaultRadius: 25, maxRadius: 50, category: 'nws', section: 'nws', subCategory: '' },
