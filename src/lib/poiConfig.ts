...
export const DEFAULT_POI_TYPES: POIConfig[] = [
  ...
  { id: 'blm_national_trails', label: 'BLM National GTLF Public Managed Trails', description: 'BLM National GTLF Public Managed Trails - linear trail network for proximity queries (up to 25 miles)', isPOI: true, defaultRadius: 0.5, maxRadius: 25, category: 'public_lands', section: 'public_lands' },
  { id: 'blm_national_motorized_trails', label: 'BLM National GTLF Public Motorized Trails', description: 'BLM National GTLF Public Motorized Trails - linear motorized trail network for proximity queries (up to 25 miles)', isPOI: true, defaultRadius: 0.5, maxRadius: 25, category: 'public_lands', section: 'public_lands' },
  { id: 'blm_national_nonmotorized_trails', label: 'BLM National GTLF Public Nonmotorized Trails', description: 'BLM National GTLF Public Nonmotorized Trails - linear nonmotorized trail network for proximity queries (up to 25 miles)', isPOI: true, defaultRadius: 0.5, maxRadius: 25, category: 'public_lands', section: 'public_lands' },
  { id: 'blm_national_grazing_pastures', label: 'BLM National Grazing Pasture Polygons', description: 'BLM National Grazing Pasture Polygons - grazing allotment and pasture boundaries for point-in-polygon and proximity queries (up to 25 miles)', isPOI: true, defaultRadius: 0.5, maxRadius: 25, category: 'public_lands', section: 'public_lands' },
