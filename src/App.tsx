        ...
        <div className={`${isMobile ? 'pt-8' : 'pt-28'} px-2 sm:px-4 md:px-6 main-container`}>
          ...
          <div className="max-w-2xl mx-auto w-full main-content">
            ...
            <div className="text-center mb-8 mt-4 sm:mt-8">
              ...
              {totalLayersCount > 0 && (
                <div className="inline-flex items-center justify-center px-1.5 sm:px-4 py-1.5 sm:py-2 mb-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 max-w-[95%] sm:max-w-none">
                  <span className="text-white font-semibold text-xs sm:text-base">
                    <span className="font-bold text-2xl sm:text-3xl">{totalLayersCount.toLocaleString()}</span> <span className="hidden sm:inline">Open Data Layers Available</span><span className="sm:hidden">Layers</span>
                  </span>
