...
const addPOIDataRows = (result: EnrichmentResult, rows: string[][]): void => {
  ...
  Object.entries(enrichments).forEach(([key, value]) => {
    ...
    if (addNriAfreqRows('nri_avalanche_hazard_type_risk_index_rating', 'Avalanche Hazard Type Risk Index Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_coastal_flooding_expected_annual_loss_rating', 'Coastal Flooding Expected Annual Loss Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_coastal_flooding_hazard_type_risk_index_rating', 'Coastal Flooding Hazard Type Risk Index Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_cold_wave_expected_annual_loss_rating', 'Cold Wave Expected Annual Loss Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_cold_wave_hazard_type_risk_index_rating', 'Cold Wave Hazard Type Risk Index Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_drought_expected_annual_loss_rating', 'Drought Expected Annual Loss Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_drought_hazard_type_risk_index_rating', 'Drought Hazard Type Risk Index Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_earthquake_expected_annual_loss_rating', 'Earthquake Expected Annual Loss Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_earthquake_hazard_type_risk_index_rating', 'Earthquake Hazard Type Risk Index Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_expected_annual_loss_rating_composite', 'Expected Annual Loss Rating Composite', 'Census Tract')) return;
    if (addNriAfreqRows('nri_hail_expected_annual_loss_rating', 'Hail Expected Annual Loss Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_hail_hazard_type_risk_index_rating', 'Hail Hazard Type Risk Index Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_heat_wave_expected_annual_loss_rating', 'Heat Wave Expected Annual Loss Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_heat_wave_hazard_type_risk_index_rating', 'Heat Wave Hazard Type Risk Index Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_ice_storm_expected_annual_loss_rating', 'Ice Storm Expected Annual Loss Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_ice_storm_hazard_type_risk_index_rating', 'Ice Storm Hazard Type Risk Index Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_inland_flooding_expected_annual_loss_rating', 'Inland Flooding Expected Annual Loss Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_inland_flooding_hazard_type_risk_index_rating', 'Inland Flooding Hazard Type Risk Index Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_landslide_expected_annual_loss_rating', 'Landslide Expected Annual Loss Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_landslide_hazard_type_risk_index_rating', 'Landslide Hazard Type Risk Index Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_lightning_expected_annual_loss_rating', 'Lightning Expected Annual Loss Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_lightning_hazard_type_risk_index_rating', 'Lightning Hazard Type Risk Index Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_social_vulnerability_rating', 'Social Vulnerability Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_strong_wind_expected_annual_loss_rating', 'Strong Wind Expected Annual Loss Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_strong_wind_hazard_type_risk_index_rating', 'Strong Wind Hazard Type Risk Index Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_tornado_expected_annual_loss_rating', 'Tornado Expected Annual Loss Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_tornado_hazard_type_risk_index_rating', 'Tornado Hazard Type Risk Index Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_tsunami_expected_annual_loss_rating', 'Tsunami Expected Annual Loss Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_tsunami_hazard_type_risk_index_rating', 'Tsunami Hazard Type Risk Index Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_volcanic_activity_expected_annual_loss_rating', 'Volcanic Activity Expected Annual Loss Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_volcanic_activity_hazard_type_risk_index_rating', 'Volcanic Activity Hazard Type Risk Index Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_wildfire_expected_annual_loss_rating', 'Wildfire Expected Annual Loss Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_wildfire_hazard_type_risk_index_rating', 'Wildfire Hazard Type Risk Index Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_winter_weather_expected_annual_loss_rating', 'Winter Weather Expected Annual Loss Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_winter_weather_hazard_type_risk_index_rating', 'Winter Weather Hazard Type Risk Index Rating', 'Census Tract')) return;
    if (addNriAfreqRows('nri_avalanche_expected_annual_loss_rating', 'Avalanche Expected Annual Loss Rating', 'County')) return;
    if (addNriAfreqRows('nri_avalanche_hazard_type_risk_index_rating', 'Avalanche Hazard Type Risk Index Rating', 'County')) return;
    if (addNriAfreqRows('nri_coastal_flooding_expected_annual_loss_rating', 'Coastal Flooding Expected Annual Loss Rating', 'County')) return;
    if (addNriAfreqRows('nri_coastal_flooding_hazard_type_risk_index_rating', 'Coastal Flooding Hazard Type Risk Index Rating', 'County')) return;
    if (addNriAfreqRows('nri_cold_wave_expected_annual_loss_rating', 'Cold Wave Expected Annual Loss Rating', 'County')) return;
    if (addNriAfreqRows('nri_cold_wave_hazard_type_risk_index_rating', 'Cold Wave Hazard Type Risk Index Rating', 'County')) return;
    if (addNriAfreqRows('nri_community_resilience_rating', 'Community Resilience Rating', 'County')) return;
    if (addNriAfreqRows('nri_drought_expected_annual_loss_rating', 'Drought Expected Annual Loss Rating', 'County')) return;
    if (addNriAfreqRows('nri_drought_hazard_type_risk_index_rating', 'Drought Hazard Type Risk Index Rating', 'County')) return;
    if (addNriAfreqRows('nri_earthquake_expected_annual_loss_rating', 'Earthquake Expected Annual Loss Rating', 'County')) return;
    if (addNriAfreqRows('nri_earthquake_hazard_type_risk_index_rating', 'Earthquake Hazard Type Risk Index Rating', 'County')) return;
    if (addNriAfreqRows('nri_hail_expected_annual_loss_rating', 'Hail Expected Annual Loss Rating', 'County')) return;
    if (addNriAfreqRows('nri_hail_hazard_type_risk_index_rating', 'Hail Hazard Type Risk Index Rating', 'County')) return;
    if (addNriAfreqRows('nri_heat_wave_expected_annual_loss_rating', 'Heat Wave Expected Annual Loss Rating', 'County')) return;
    if (addNriAfreqRows('nri_heat_wave_hazard_type_risk_index_rating', 'Heat Wave Hazard Type Risk Index Rating', 'County')) return;
    if (addNriAfreqRows('nri_hurricane_expected_annual_loss_rating', 'Hurricane Expected Annual Loss Rating', 'County')) return;
    if (addNriAfreqRows('nri_hurricane_hazard_type_risk_index_rating', 'Hurricane Hazard Type Risk Index Rating', 'County')) return;
    if (addNriAfreqRows('nri_ice_storm_expected_annual_loss_rating', 'Ice Storm Expected Annual Loss Rating', 'County')) return;
    if (addNriAfreqRows('nri_ice_storm_hazard_type_risk_index_rating', 'Ice Storm Hazard Type Risk Index Rating', 'County')) return;
    if (addNriAfreqRows('nri_inland_flooding_expected_annual_loss_rating', 'Inland Flooding Expected Annual Loss Rating', 'County')) return;
    if (addNriAfreqRows('nri_inland_flooding_hazard_type_risk_index_rating', 'Inland Flooding Hazard Type Risk Index Rating', 'County')) return;
    if (addNriAfreqRows('nri_landslide_expected_annual_loss_rating', 'Landslide Expected Annual Loss Rating', 'County')) return;
    if (addNriAfreqRows('nri_landslide_hazard_type_risk_index_rating', 'Landslide Hazard Type Risk Index Rating', 'County')) return;
    if (addNriAfreqRows('nri_lightning_expected_annual_loss_rating', 'Lightning Expected Annual Loss Rating', 'County')) return;
    if (addNriAfreqRows('nri_national_risk_index_rating_composite', 'National Risk Index Rating Composite', 'County')) return;
    if (addNriAfreqRows('nri_strong_wind_expected_annual_loss_rating', 'Strong Wind Expected Annual Loss Rating', 'County')) return;
    if (addNriAfreqRows('nri_strong_wind_hazard_type_risk_index_rating', 'Strong Wind Hazard Type Risk Index Rating', 'County')) return;
    if (addNriAfreqRows('nri_tornado_expected_annual_loss_rating', 'Tornado Expected Annual Loss Rating', 'County')) return;
    if (addNriAfreqRows('nri_tornado_hazard_type_risk_index_rating', 'Tornado Hazard Type Risk Index Rating', 'County')) return;
    if (addNriAfreqRows('nri_tsunami_expected_annual_loss_rating', 'Tsunami Expected Annual Loss Rating', 'County')) return;
    if (addNriAfreqRows('nri_tsunami_hazard_type_risk_index_rating', 'Tsunami Hazard Type Risk Index Rating', 'County')) return;
    if (addNriAfreqRows('nri_volcanic_activity_expected_annual_loss_rating', 'Volcanic Activity Expected Annual Loss Rating', 'County')) return;
    if (addNriAfreqRows('nri_volcanic_activity_hazard_type_risk_index_rating', 'Volcanic Activity Hazard Type Risk Index Rating', 'County')) return;
    if (addNriAfreqRows('nri_wildfire_expected_annual_loss_rating', 'Wildfire Expected Annual Loss Rating', 'County')) return;
    if (addNriAfreqRows('nri_wildfire_hazard_type_risk_index_rating', 'Wildfire Hazard Type Risk Index Rating', 'County')) return;
    if (addNriAfreqRows('nri_winter_weather_expected_annual_loss_rating', 'Winter Weather Expected Annual Loss Rating', 'County')) return;
    if (addNriAfreqRows('nri_winter_weather_hazard_type_risk_index_rating', 'Winter Weather Hazard Type Risk Index Rating', 'County')) return;
